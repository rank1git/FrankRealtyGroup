...
const FAQ = () => {
	...
	return (
		<>
			...
			>
				To list your property, you can either contact one of our agents directly
				or fill out our online form. We will arrange a property evaluation and
				guide you through the listing process, including setting a competitive
			...
			>
				...
				commissions range between 5% to 6% for selling properties. For leasing,
				fees are generally one month’s rent. Contact us for specific details
				regarding your property and transaction.
			</Question>
			<Question
			...
			>
				The time it takes to sell a property depends on various factors such as
				location, market conditions, and pricing. On average, properties can
				take anywhere from a few weeks to several months to sell. We use
			...
			>
				We offer a free, no-obligation property evaluation where our agents will
				assess the value of your property based on comparable sales in the area,
				current market trends, and the condition of your property.
			</Question>
			<Question
			...
			>
				...
				negotiating the terms, conducting inspections, and closing the sale. Our
				agents will guide you every step of the way to make the process as
				smooth as possible.
			</Question>
			<Question
				title={
			...
			>
				...
				important to work with someone you trust and who understands your needs.
			</Question>
			<Question
			...
			>
				...
				and other economic factors. We offer detailed market reports to give you
				an overview of current trends in your area. Contact us to receive a
				customized report.
			</Question>
		</>
	);
